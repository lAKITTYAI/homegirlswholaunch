  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-lavender-50 to-white">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl md:text-2xl text-lavender-700 mb-8 leading-relaxed">
              Discover luxury Black-owned businesses curated for excellence
            </p>
            <Button 
              size="lg" 
              className="bg-gold-500 hover:bg-gold-600 text-luxury-charcoal font-semibold px-8 py-6 text-lg"
            ...
            <div className="flex flex-col md:flex-row gap-4">
              <div className="flex-1 relative">
                ...
                <Input
                  ...
                  className="pl-12 h-12 bg-lavender-50 border-lavender-200 text-lg focus:border-gold-500"
                />
              </div>
              <select
      ...
      {filteredBusinesses.filter(b => b.listing_type === "featured").length > 0 && (
        <section className="py-16 bg-gradient-to-br from-gold-50 to-lavender-50">
          <div className="container mx-auto px-4">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-7xl mx-auto">
            ...
            {loading ? (
              ...
              <div className="text-center py-20 bg-lavender-50 rounded-2xl">
                <p className="text-xl text-lavender-600 mb-6">No businesses found matching your criteria</p>
                <Button 
                  onClick={() => setShowGetListed(true)} 
                  className="bg-gold-500 hover:bg-gold-600 text-luxury-charcoal"
                >
                  ...
                  <Link key={business.id} to={`/business/${business.id}`}>
                    <Card className="overflow-hidden hover:shadow-xl transition-all duration-300 border border-lavender-200 hover:border-lavender-400 group bg-white h-full">
                      <div className="aspect-[4/3] relative overflow-hidden bg-lavender-100">
                        ...
                        {business.verified && (
                          <Badge className="absolute top-4 right-4 bg-gold-500/90 text-luxury-charcoal border-0">
                            <CheckCircle2 className="h-3 w-3 mr-1" />
                            Verified
                          </Badge>
                        )}
      ...
      <section className="py-24 bg-gradient-to-r from-lavender-100 via-gold-50 to-lavender-100">
        <div className="container mx-auto px-4 text-center">
          ...
          <Button 
            size="lg" 
            className="bg-gold-500 hover:bg-gold-600 text-luxury-charcoal font-semibold px-10 py-7 text-lg"
            onClick={() => setShowGetListed(true)}
          >
